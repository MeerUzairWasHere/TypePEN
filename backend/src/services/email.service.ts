...
import { emailDetails, nodemailerConfig } from "../configs/nodemailer";

export class EmailService {
  private company: CompanyInfo;
  private transporter: any;

  constructor(company: CompanyInfo, nodemailerConfig: any) {
...
export const emailService = new EmailService(emailDetails, nodemailerConfig);
