    ...
    const html = `<div style="background-color: #ffffff; font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="padding: 24px;">
        ...
        <div style="text-align: center; margin: 32px 0;">
          <a href="${company.website}" style="display: inline-block; background-color: #9333ea; color: white; font-weight: 600; padding: 14px 28px; border-radius: 6px; text-decoration: none; font-size: 16px;">Get Started</a>
        </div>
